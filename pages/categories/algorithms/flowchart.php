...
<body>
  ...
  <main>
    <div>
      <img src="../../../images/flowchart.png" alt="Diagrama de flujo" title="Diagrama de flujo">
      <h3>¿Qué es un diagrama de flujo?</h3>
      <p>
        El diagrama de flujo o flujograma o diagrama de actividades es la representación gráfica de un algoritmo 
        o proceso. Se utiliza en disciplinas como programación, economía, procesos industriales y psicología cognitiva.
      </p>
    </div>
  </main>
  <!-- END OF MAIN -->
